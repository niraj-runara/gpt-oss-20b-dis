#!/usr/bin/env bash
# ==============================================================================
# GCE metadata startup-script for `decode-node` (g2-standard-16, 1x L4).
...
#     --metadata-from-file startup-script=decode-node-startup.sh
#   gcloud compute instances reset decode-node --zone=us-central1-a
#
